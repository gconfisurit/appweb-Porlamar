...
class LibroVenta extends Conectar
{
    public function getLibroPorFecha($fechai, $fechaf)
    {
        ...
        //QUERY
        $sql = "SELECT totalventas, MontoIVA_ContribuyeIVA14, mtoexento, fechaemision, rifcliente, nombre, tipodoc, numerodoc, nroctrol, tiporeg, factafectada, Alicuota_ContribuyeIVA14
                FROM [MCONFISUR].DBO.VW_ADM_LIBROIVAVENTAS
