	...
	public function getNEporcobrar($fechai, $fechaf){
       ...
       parent::set_names();
        ...
        //QUERY
          ...
          $sql = "SELECT 
          (select Descrip from MCONFISUR_D.dbo.SACONF) as Empresa,
      ...
      switch ($data) {
        ...
        case 1:
          ...
          DATEDIFF(DD, saacxc.fechae, CONVERT( date ,GETDATE()))as DiasTransHoy,
           ...
           (select Coordinador from MCONFISUR_D.dbo.SAVEND_01 where SAVEND_01.CodVend = saacxc.CodVend) as Supervisor
           from MCONFISUR_D.dbo.saacxc inner join saclie on saacxc.codclie = saclie.codclie 
