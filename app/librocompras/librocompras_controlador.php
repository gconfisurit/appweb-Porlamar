    ...
    case 'listar_librocompras':
        ...
        if (is_array($datos) == true and count($datos) > 0) {
            foreach ($datos as $key => $row) {
                ...
                $sub_array['totalcompra'] = Strings::rdecimal(
                    $row['totalcompra'],
                    2
                );
                $sub_array['alicuota_iva'] = Strings::rdecimal(
                    $row['alicuota_iva14'],
                    0
                );
                $sub_array['monto_iva'] = Strings::rdecimal(
                    $row['Monto_IVA14'],
                    2
                );
                ...
                $sub_array['porctreten'] = Strings::rdecimal(
                    $row['porctreten'],
                    0
                );
                $sub_array['fecharetencion'] = Strings::avoidNull(
                    $row['fecharetencion']
                );
        ...
        $resumen = [
            ...
            [
                'descripcion' =>
                    'Total Compras Importación Afectas solo Alícuota General',
            ...
            [
                'descripcion' =>
                    'Total Compras Importación Afectas en Alícuota General + Adicional',
                'base_imponible' => Strings::rdecimal(0, 2),
                'credito_fiscal' => Strings::rdecimal(0, 2),
                'isBold' => false,
                'isColored' => false,
            ...
            [
                'descripcion' =>
                    'Total Compras Importación Afectas en Alícuota Reducida',
                'base_imponible' => Strings::rdecimal(0, 2),
                'credito_fiscal' => Strings::rdecimal(0, 2),
                'isBold' => false,
                'isColored' => false,
            ...
            [
                'descripcion' =>
                    'Total Compras Internas Afectas solo Alícuota General (16%): ',
            ...
            [
                'descripcion' =>
                    'Total Compras Internas Afectas solo Alícuota General + Adicional',
                'base_imponible' => Strings::rdecimal(0, 2),
                'credito_fiscal' => Strings::rdecimal(0, 2),
                'isBold' => false,
                'isColored' => false,
            ...
            [
                'descripcion' =>
                    'Total Compras Internas Afectas solo Alícuota Reducida',
                'base_imponible' => Strings::rdecimal(0, 2),
                'credito_fiscal' => Strings::rdecimal(0, 2),
                'isBold' => false,
                'isColored' => false,
            ...
            [
                'descripcion' =>
                    'Excedente de Crédito Fiscal del Periodo Anterior',
                'base_imponible' => Strings::rdecimal(0, 2),
                'credito_fiscal' => Strings::rdecimal(0, 2),
                'isBold' => false,
                'isColored' => false,
