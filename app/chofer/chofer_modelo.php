...
class Chofer extends Conectar
{
    public function registrar_chofer($data)
    {
        ...
        $sql =
            'INSERT INTO appchofer (cedula, descripcion , estatus) VALUES(?,?,?);';
    ...
    public function editar_chofer($data)
    {
        ...
        $sql =
            'UPDATE [mconfisur].[dbo].appchofer SET descripcion=?, estatus=?  WHERE cedula=?';
    ...
    public function editar_estado($id, $estado)
    {
        ...
        $sql = 'UPDATE [mconfisur].[dbo].appchofer SET estado=? WHERE cedula=?';
    ...
    public function eliminar_chofer($id)
    {
        ...
        $sql =
            'UPDATE [mconfisur].[dbo].appchofer SET deleted_at=? WHERE Cedula=?';
