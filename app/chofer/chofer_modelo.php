...
class Chofer extends Conectar
{
    ...
    public function editar_chofer($data)
    {
        ...
        $sql = "UPDATE [MCONFISUR_D].[dbo].appchofer SET descripcion=?, estatus=?  WHERE cedula=?";
    ...
    public function editar_estado($id, $estado)
    {
        ...
        $sql = "UPDATE [MCONFISUR_D].[dbo].appchofer SET estado=? WHERE cedula=?";
...
//    $sql = "DELETE FROM choferes WHERE id = ?";
        $sql = "UPDATE [MCONFISUR_D].[dbo].appchofer SET deleted_at=? WHERE Cedula=?";
