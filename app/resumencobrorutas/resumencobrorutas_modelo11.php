       ...
       parent::set_names();
        ...
        //QUERY
            if($tipo === 'B' and $ruta === 'Todos'){
              ...
              p.Monto - isnull((select dev.Monto from [MCONFISUR_D].[dbo].SAACXC as dev where dev.NroUnico = p.NroPpal and dev.TipoCxc in ('31')),0) 
              ...
              p.Monto - isnull((select dev.Monto from [MCONFISUR_D].[dbo].SAACXC as dev where dev.NroUnico = p.NroPpal and dev.TipoCxc in ('31')),0) Total
