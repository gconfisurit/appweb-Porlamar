...
saacxcaux1.saldo as SaldoPend,  (select codvend from safact where SAFACT.numerod = SAACXCAUX1.numerod) as ruta
 from saacxcaux1 inner join saclie on saacxcaux1.codclie = saclie.codclie
...
saacxcaux1.saldo as SaldoPend,  (select codvend from safact where SAFACT.numerod = SAACXCAUX1.numerod) as ruta
 from saacxcaux1 inner join saclie on saacxcaux1.codclie = saclie.codclie
where (saacxcaux1.FechaE < DATEADD(day, -40, CONVERT( date ,GETDATE()))) and saacxcaux1.saldo>0 AND saacxcaux1.tipocxc='10'  and saacxcaux1.estado =0
order by saacxcaux1.FechaE asc";
                break;
